...
import { ShieldAlert, AlertTriangle, UserMinus, SquarePlus, History, BarChart3, TrendingUp, MapPin, ChevronRight, MessageSquare, ThumbsUp, Share2, Megaphone } from "lucide-react"
...
const QUICK_ACTIONS = [
  { label: "Reportar Incidente", icon: SquarePlus, href: "/reportar", color: "bg-primary" },
